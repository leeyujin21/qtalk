...
public class XMLtoDB {
	...
	public static void main(String[] args) {
		try {
			String url = "http://openapi.q-net.or.kr/api/service/rest/InquiryListNationalQualifcationSVC/getList?serviceKey=dn5V7VHzMAAH9UmfOInjhNIBWgJak1bNISgkquqQu7anHP%2BpKIBznJZtPV6%2FFGYD88Htbt8kVBuW3MGh7rVvHA%3D%3D&";
			...
			// 3. 데이터 삽입
			String sql = "INSERT INTO examinfo (jmcd, jmfldnm,  obligfldcd, obligfldnm, mdobligfldcd, seriescd, seriesnm,mdobligfldnm,qualgbcd, qualgbnm) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
			...
			for (int temp = 0; temp < nList.getLength(); temp++) {
				...
				if (nNode.getNodeType() == Node.ELEMENT_NODE) {
					...
					pstmt.setString(1, getTagValue("jmcd", eElement));
